                ...
                <ImageBackground
                  ...
                  source={
                    this.state.SelectPackNum === index
                      ...
                      : this.state.BackgroundUnselected
                  }>
                  <TouchableWithoutFeedback
                      ...
                      <View style={styles.packageItemLeft}>
                        <View style={styles.packageItemLeftBox}>
                          ...
                          <Text
                            style={
                              this.state.SelectPackNum !== index
                                ? styles.packageItemLeftOne
                                : styles.packageItemLeftThree
                            }>
                            {item.type}
                          </Text>
                        </View>
                        <Text style={styles.packageItemLeftTwo}>
                          {item.name}
                        </Text>
                      </View>
                      <View style={styles.packageItemRight}>
                        <Text style={styles.packageItemRightOne}>
                          ¥{item.price}
                        </Text>
                      </View>
                    </View>
