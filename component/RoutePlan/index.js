...
export default class index extends Component {
                                                    ...
                                                    <View style={styles.PointListItem}>
                                                        <View style={styles.PointListItemLeft}>
                                                            ...
                                                            <View style={styles.PointListItemEnd}>
                                                                ...
                                                                {
                                                                    item.segments[0].bus && item.segments[0].bus.buslines[0] &&
                                                                    <Text
                                        ...
                                        <View style={styles.PointListItemLeft}>
                                            <View style={styles.PointListItemTop}>
                                                <FontAwesome5 name='walking' size={20}
                                                              ...
                                                              style={styles.PointListItemTopIcon}></FontAwesome5>
                                                <Text
                                                    style={styles.PointListItemTopText}>{this.state.RouteaAllMsg.distance}米</Text>
                                            </View>
                                            <View style={styles.PointListItemCenter}>
                                                <View style={styles.PointListItemCenterBox}>
                                                    <View
    ...
    handleCountRoute = (data) => {
        ...
        Actions.push('route_plan_detail', {
            Polyline: Polyline,
            RouteMsg: this.state.RouteMsg[this.state.selectRoutePlan]
        })
    }
