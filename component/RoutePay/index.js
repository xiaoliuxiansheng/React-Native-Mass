...
import {
    ...
    SafeAreaView, StatusBar, NativeModules, Dimensions
} from 'react-native'
                ...
                <View style={styles.RoutePay}>
                    <View style={styles.RoutePayHead}>
                        <View style={styles.RoutePayHeadLeft}>
                            <FontAwesome5 name='walking' size={22}
                                          color='#fff'
                                          style={styles.RoutePayHeadLeftIcon}></FontAwesome5>
                            <FontAwesome name='subway' size={22}
                                         color='#fff'
                                         style={styles.RoutePayHeadLeftIcon}></FontAwesome>
                        </View>
                        <View style={styles.RoutePayHeadCenter}>
                            <View style={styles.RoutePayHeadCenterCircle}></View>
                            {
                                ['','',''].map((item,index)=>{
                                    return (
                                        <View style={[styles.RoutePayHeadCenterCircleItem,{marginTop:index === 0 ? 14:null}]}></View>
                                    )
                                })
                            }
                            <View style={styles.RoutePayHeadCenterCircle}></View>
                        ...
                        <View style={styles.RoutePayHeadRight}>
                            <View style={styles.RoutePayHeadRightContent}>
                                <Text style={styles.RoutePayHeadRightText}>中国评剧艺术中心</Text>
                                {/*<Text style={styles.RoutePayHeadRightPrice}></Text>*/}
                            </View>
                            <View style={styles.RoutePayHeadRightContent}>
                                <Text style={styles.RoutePayHeadRightText}>北京南站 地铁站-D西南口</Text>
                                <Text style={styles.RoutePayHeadRightPrice}>0元</Text>
                            </View>
                            <View style={styles.RoutePayHeadRightContent}>
                                <Text style={styles.RoutePayHeadRightText}>建国门 地铁站</Text>
                    ...
                    <View style={styles.RoutePayBtn}>
                        <TouchableWithoutFeedback onPress = {() =>  Actions.push('route-pay-evaluate')}>
                            <View style={styles.RoutePayBtnBox}><Text style={styles.RoutePayBtnText}>点击支付</Text></View>
                        </TouchableWithoutFeedback>
                    </View>
                </View>
            </SafeAreaView>
