...
export default class evaluate extends Component {
  ...
  // 提交评论退出
  handlePushMsg = () => {
    Toast.loading('正在提交评价', 3);
    setTimeout(() => Actions.push('launch'), 3000);
  };
          ...
          <Provider>
            <View style={styles.Evaluate}>
                  ...
                  return (
                    <TouchableWithoutFeedback
                      ...
                      <FontAwesome
                        ...
                        size={38}
                        color={
                          index < this.state.startNum
                            ? 'rgba(0, 157, 250, 1.000)'
                            : 'rgba(67, 83, 104, 1.000)'
                        }
                        style={styles.EvaluateStartItem}
                      />
                    </TouchableWithoutFeedback>
                  );
                })}
              ...
              <View style={styles.EvaluateStartText}>
                <Text style={styles.EvaluateStartTexts}>为行程点个赞吧</Text>
              </View>
              <View style={styles.EvaluateCheck}>
                {['', '', '', ''].map((item, index) => {
                  return (
                    <TouchableWithoutFeedback
                      onPress={this.handleCheckItem.bind(this, index)}>
                      <View style={styles.EvaluateCheckItem}>
                        <View
                          style={[
                            styles.EvaluateCheckItemCircle,
                            {
                              backgroundColor: this.state.CheckResult.includes(
                                index,
                              )
                                ? 'rgba(0, 157, 250, 1.000)'
                                : 'rgba(67, 83, 104, 1.000)',
                        ...
                        <Text style={styles.EvaluateCheckItemText}>
                          路况准确
                        </Text>
                      </View>
                    </TouchableWithoutFeedback>
              ...
              <View style={styles.EvaluateBottom}>
                ...
                <View style={styles.EvaluateBottomMsg}>
                  <TouchableWithoutFeedback
                    ...
                    <View
                      style={[
                        styles.EvaluateBottomMsgCheck,
                        {
                          backgroundColor: this.state.isanonymous
                            ? 'rgba(0, 157, 250, 1.000)'
                            : 'rgba(67, 83, 104, 1.000)',
                        },
                      ]}>
