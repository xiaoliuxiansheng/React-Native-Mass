...
public class InvestigateChatRow extends BaseChatRow {
    ...
    protected void buildChattingData(final Context context, BaseHolder baseHolder, FromToMessage detail, int position) {
        ...
        final String satifyThank = sp.getString("satisfyThank",context.getString(R.string.satisfy_thank));
        if(message != null) {

            investigate_tv.setText( sp.getString("satisfyTitle",context.getString(R.string.satisfy_title)));
